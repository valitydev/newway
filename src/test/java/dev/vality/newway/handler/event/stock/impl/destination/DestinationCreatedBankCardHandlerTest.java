...
public class DestinationCreatedBankCardHandlerTest {
    ...
    public void destinationCreatedHandlerTest() {
        ...
        Assertions.assertNotNull(Objects.requireNonNull(destinationResult).getResourceBankCardBin());
        Assertions.assertNotNull(destinationResult.getResourceBankCardMaskedPan());
        Assertions.assertNotNull(destinationResult.getResourceBankCardToken());
    }
