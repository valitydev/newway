...
import dev.vality.newway.util.ShopUtil;
...
public class ShopCreatedHandler extends AbstractClaimChangedHandler {
    ...
    private void handleEvent(MachineEvent event, Integer changeId, ClaimEffect e, Integer claimEffectId) {
        ...
        dev.vality.newway.domain.tables.pojos.Shop shop =
    ...
    private dev.vality.newway.domain.tables.pojos.Shop createShop(MachineEvent event, Integer changeId,
                                                                  long sequenceId,
                                                                  Shop shopCreated, String shopId, String partyId,
                                                                  Integer claimEffectId) {
        dev.vality.newway.domain.tables.pojos.Shop shop = new dev.vality.newway.domain.tables.pojos.Shop();
